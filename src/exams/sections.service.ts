...
export class SectionsService {
  ...
  async create(createSectionDto: CreateSectionDto, examId: string): Promise<Section> {
  ...
  async updateOrder(id: string, newOrder: number): Promise<Section> {
    ...
    if (section.exam.status === 'published') {
      throw new BadRequestException('Cannot update section order of published exam');
    }
