...
export class AnswersController {
  ...
  getUnansweredQuestions(@Param('attemptId') attemptId: string, @Request() req) {
  ...
  getQuestionAnswer(
    ...
    return this.answersService.getQuestionAnswer(questionId, attemptId, req.user.id);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAnswerDto: UpdateAnswerDto, @Request() req) {
